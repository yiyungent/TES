...
namespace WebUI.Areas.Admin.Controllers
{
    public class SysMenuController : Controller
    {
        ...
        {
            Sys_Menu model = Container.Instance.Resolve<Sys_MenuService>().GetEntity(id);
            int parentId = model.ParentMenu?.ID ?? 0;
            ViewBag.DDLParent = InitDDLForParent(model, parentId);
        ...
        public JsonResult Edit(Sys_Menu inputModel)
        {
            try
            {
                ...
                //dbModel.AreaName = inputModel.AreaName;
                //dbModel.ControllerName = inputModel.ControllerName;
                //dbModel.ActionName = inputModel.ActionName;
